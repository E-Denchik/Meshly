...
public final class AppDatabase_Impl extends AppDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `contacts` (`jamiId` TEXT NOT NULL, `displayName` TEXT NOT NULL, `username` TEXT, `status` TEXT NOT NULL, `presence` TEXT NOT NULL, `addedAt` INTEGER NOT NULL, PRIMARY KEY(`jamiId`))");
        db.execSQL("CREATE TABLE IF NOT EXISTS `chat_messages` (`id` TEXT NOT NULL, `conversationId` TEXT NOT NULL, `senderJamiId` TEXT NOT NULL, `text` TEXT NOT NULL, `timestamp` INTEGER NOT NULL, `status` TEXT NOT NULL, `attachmentPath` TEXT, `isIncoming` INTEGER NOT NULL, PRIMARY KEY(`id`))");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'e349f70d1c039c89f7b7d7a7f6c15105')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        _columnsContacts.put("jamiId", new TableInfo.Column("jamiId", "TEXT", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _columnsContacts.put("presence", new TableInfo.Column("presence", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (!_infoContacts.equals(_existingContacts)) {
          return new RoomOpenHelper.ValidationResult(false, "contacts(org.meshly.app.data.local.ContactEntity).\n"
                  + " Expected:\n" + _infoContacts + "\n"
                  + " Found:\n" + _existingContacts);
        }
        ...
        _columnsChatMessages.put("senderJamiId", new TableInfo.Column("senderJamiId", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _columnsChatMessages.put("isIncoming", new TableInfo.Column("isIncoming", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (!_infoChatMessages.equals(_existingChatMessages)) {
          return new RoomOpenHelper.ValidationResult(false, "chat_messages(org.meshly.app.data.local.ChatMessageEntity).\n"
                  + " Expected:\n" + _infoChatMessages + "\n"
                  + " Found:\n" + _existingChatMessages);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "e349f70d1c039c89f7b7d7a7f6c15105", "35dc75a6e90d09b2cc62ec560f5ff808");
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "contacts","chat_messages");
  }
